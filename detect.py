...
Verifies that PTRACE_SEIZE (used by agentsh v0.20.3 attach_mode: "children")
    ...
    try:
        ...
        if session_id:
            ...
            fa_out, _, fa_rc = run(
                ...
                "python3 -c \"p='/root/test.txt'; open(p,'w').write('hello from agent'); print(open(p).read(), end='')\" 2>&1",
