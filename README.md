...
Runtime security governance for AI agents using [agentsh](https://github.com/canyonroad/agentsh) v0.18.0 with [Modal Sandboxes](https://modal.com/products/sandboxes).
...
- **Version verification** -- Confirm v0.18.0 with ptrace active
